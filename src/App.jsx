...
const App = () => {
  return (
    <div className="flex items-center justify-center absolute top-10 left-0 right-0 max-md:absolute max-md:top-25">
      <div className="outline-2 outline-blue-400 rounded-3xl px-5 py-10  w-[420px] max-lg:m-auto max-lg:max-md:w-[320px] left-0 right-0 m-auto">
